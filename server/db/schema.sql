...
CREATE TABLE IF NOT EXISTS `aircraft` (
  ...
  `auw_g`         INT UNSIGNED DEFAULT NULL,
  `wingspan_mm`   INT UNSIGNED DEFAULT NULL,
  `length_mm`     INT UNSIGNED DEFAULT NULL,
  `frame_size_mm` INT UNSIGNED DEFAULT NULL,
  ...
  `cruise_speed_kmh` SMALLINT UNSIGNED DEFAULT NULL,
  `stall_speed_kmh`  SMALLINT UNSIGNED DEFAULT NULL,
  `range_km`         SMALLINT UNSIGNED DEFAULT NULL,
  `payload_g`        INT UNSIGNED DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `user_log_mappings` (
  ...
  `mapped_to`   VARCHAR(100) NOT NULL,   -- 'camera_trigger', 'ignore', 'custom:label'
