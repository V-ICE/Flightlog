...
|----------------|-------|
| Installing on **cPanel shared hosting** | `Flightlog_Install_Guide.pdf` |
| Installing with **Docker on any PC** (Windows / macOS / Linux overview) | `Flightlog_PC_Docker_Install.pdf` |
| Installing with **Docker on Ubuntu** server or desktop | `Flightlog_Ubuntu_Docker_Install.pdf` |
| Installing with **Docker** (generic — all platforms, includes Nginx SSL) | `Flightlog_Docker_Install.pdf` |
| Installing on **Synology DS412+** via Docker | `Flightlog_Synology_DS412_Docker.pdf` |
...
Do you have a web hosting account (cPanel)?
  └── YES → Flightlog_Install_Guide.pdf

Do you want to run Docker?
  ├── On Ubuntu (server or desktop)
  │     └── Flightlog_Ubuntu_Docker_Install.pdf
  ├── On Windows or macOS
  │     └── Flightlog_PC_Docker_Install.pdf
  └── On Synology DS412+
        ├── First: DS412_RAM_Upgrade_Guide.pdf  (if you have 1 GB RAM)
        └── Then:  Flightlog_Synology_DS412_Docker.pdf
```

## What each guide covers

### Flightlog_Install_Guide.pdf
...
### Flightlog_Ubuntu_Docker_Install.pdf  ← Start here for Ubuntu
...
### Flightlog_Synology_DS412_Docker.pdf
